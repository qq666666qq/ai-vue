    ...
    <div class="home-container">
        <div class="content">
            <div class="text">
                ...
                <p class="description">
                    与AI机器人进行互动，分享你的情感，获得支持。
                </p>
                <div class="hero-actions">
                    <el-button  size="large">开始倾诉，获得陪伴</el-button>
                    <el-button  size="large"style="border-color: #fff" color="transparent" type="primary">记录心情，获得情感</el-button>
                </div>
            </div>
            <div class="robot">
                <img width="150px" height="150px" :src="robotImage" alt="AI机器人" />
            </div>
        </div>
    </div>
</template>
